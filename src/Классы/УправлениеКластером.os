...
Процедура ОтключитьСеансыИнформационнойБазы(Знач ИнформационнаяБаза, Знач Фильтр = Неопределено) Экспорт
	...
	Для Каждого Сеанс Из СеансыБазы Цикл
		...
		Лог.Информация("Отключаю сеанс %3 - <%1>, <%2>", Сеанс.Пользователь, Сеанс.Приложение, Сеанс.НомерСеанса );
...
Процедура ОтключитьСоединенияИнформационнойБазы(Знач ИнформационнаяБаза, Знач Фильтр = Неопределено) Экспорт
	...
	Лог.Информация("Отключаю существующие соединения");
	...
	Для Каждого Соединение Из СоединенияБазы Цикл
		...
		Лог.Информация("Отключаю соединение %3 - <%1>, <%2>", 
...
//	  * ВыдаватьЛицензииСервером - Булево - текущее состояние выдачи лицензий сервером
...
Функция ПолучитьПодробноеОписаниеИнформационнойБазы(Знач ИнформационнаяБаза, Знач АвторизацияИБ = Неопределено) Экспорт
	...
	ПодробноеОписаниеИБ.Вставить("ВыдаватьЛицензииСервером", ?(Данные["license-distribution"] = "allow", Истина, Ложь));
...
//   ВыдаватьЛицензииСервером - Булево - признак выдачи лицензий сервером
...
Функция СоздатьИнформационнуюБазу(Знач Кластер,
									...
									Знач ВыдаватьЛицензииСервером = Ложь,
									Знач СоздатьБазуДанных = Ложь
									) Экспорт

	Лог.Информация("Создаю новую базу данных %1", Наименование);
	...
	Параметры.Добавить("--license-distribution=" + ?(ВыдаватьЛицензииСервером, "allow", "deny"));
	...
	Лог.Информация("Новая база данных %1 создана", Наименование);
...
Процедура УдалитьИнформационнуюБазу(Знач ИнформационнаяБаза,
	...
	Лог.Информация("Удаляю базу данных %1", ИнформационнаяБаза);
	...
	Лог.Информация("Удаление базы данных %1 завершено", ИнформационнаяБаза);
